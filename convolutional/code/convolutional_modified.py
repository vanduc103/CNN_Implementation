...
### define model
# convolution-pooling-norm layer define
def conv2d(x, W):
...
# convolution-pooling-norm layer #1
...
# convolution-norm-pooling layer #2
W_conv2 = weight_variable([filter_size, filter_size, filter_num, filter_num])
...
# fully connected #3
pool2_reshape = tf.reshape(pool2, [-1, 8*8*filter_num])
